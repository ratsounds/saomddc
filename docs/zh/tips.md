...
> - 世界樹(世界樹上的重遇)招募。亞絲娜是★6霸體，桐人是護盾x2+回復抽中其中一個都可以輕鬆通關。
> - 聖/暗屬性精選招募。目標是護盾x2+回復的三神角色。理想是三神詩乃バリアx2+回復の三神キャラ狙い。理想は三神シノン。
> - 陪睡(軟棉棉SweetDreams)招募。高手向。火力是最高等級。
> - 在[「漫畫選集」發售特別活動!!](https://api-defrag-ap.wrightflyer.net/webview/announcement-detail?id=20190420&phone_type=2&lang=tc)贈送了兩個附有自我回復的★6角色所以希望可以現在開始拿到手。世界樹和精選招募都是直至5/7 14:00 (UTC+8)所以如果要刷首抽的話就可以努力到這個時間。
>
> #### 陷阱
> - 初期主要運用角色用法杖是條艱辛的道路。
