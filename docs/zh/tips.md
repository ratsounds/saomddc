...
> 提前做好下表的攻擊＋無稱號的隊伍，參考備忘以上至下的順序用各個角色分別檢查其給予傷害是否合符條件就能夠大概地得知防禦和debuff的有效性。應注意的，是攻擊力需要自己計算BS等。實際上探找以 **★ $dmg>1$** 作為境界的角色就能推測到防禦值，但想更嚴密地測定的話請參考[防禦的測定](../knowledge/#防禦的測定)。
> 
> #### 簡易防禦測定用隊伍構成
>
> ||攻撃力|代表性角色|
