...
|DPS|パリィキャンセル時の推定DPS。槍・杖・チャージキャラはパリィキャンセルによりパリィモーションが0.2secキャンセルされたと見なしてDPSを計算する。|
|CDPS|パリィキャンセル時の推定DPS.槍・杖・チャージキャラはパリィキャンセルによりパリィモーションが0.2secキャンセルされたと見なしてDPSを計算する。|
...
|DPS|${Damage}/({Duration}-0.2)$|
|CDPS|${Damage}/({CSec}-0.2)$|
