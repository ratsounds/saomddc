...
> - 聖属性ガチャ。三神直葉はバリアx2+回復で火力も高いが、同じ三神のシノンやユウキに比べるとややMP回復に苦労する。闇や水属性ガチャを待って他の三神狙いというのも・・・。
> - プールガチャ。優先度はSAやバリアキャラより低いが、回復キャラなのでクエスト用キャラがいなければ。
> - 嫁19各種。初心者向けではない。今後ランイベでがんばる予定ならどちらも欲しい。特に連携バフの風嫁ガチャはバフ要員としてかなり強力。一方火嫁は強クリバフなのでギルランがんばりたい人は確保すること。
>
> #### 罠
> - 初期メインキャラで杖は茨の道。
...
> |回復持ち|対毒持ち雑魚用に。|
> |杖|S1での回復用に防具とアクセだけ付けてステージ切替時に運用。|
>
> #### リザード対策
> 舌の麻痺攻撃や画面外からの突進攻撃で事故り易い。
> できる限りバリア持ちかSAキャラを当てたい。バリアキャラが回復を持っていない場合は杖キャラポーションでサポートする。バリアやSAキャラが使えなく、回復キャラで挑む場合は、S3にこだわらずS1等でダウンを取りにいったほうが安定することが多い。細剣のS1等がおすすめ。また自動銃で軸をずらしながら逃げ回ったり、片手棍のPG等でなんとかするのも有効。
>
> #### スライム対策
...
>
> #### ボス戦の戦略
> 基本的には立ち回りキャラ＋他２キャラの構成が低リスク。他２キャラの構成は単純な火力を2枚入れる場合と、バフキャラを入れる場合がある。例えば三神キャラのように立ち回りキャラがそもそも高火力の場合はバフキャラ２枚で良い。逆に立ち回りキャラの火力が低い場合は、火力要員を2枚、あるいはバフ＋火力の構成が望ましい。
>
> #### 戦略的撤退
